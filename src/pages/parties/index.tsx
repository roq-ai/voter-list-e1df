...
type ColumnType = ColumnDef<PartyInterface, unknown>;
...
export function PartyListPage(props: PartyListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<PartyInterface>>(
    () => `/parties?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/parties/view/${record.id}`} passHref legacyBehavior>
                <Button
